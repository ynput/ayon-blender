...
class BlenderPlaceholderScriptPlugin(BlenderPlaceholderPlugin):
    ...
    def prepare_placeholders(self, placeholders):
        super(BlenderPlaceholderScriptPlugin, self).prepare_placeholders(
            placeholders
        )
